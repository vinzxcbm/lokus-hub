...
local Window = WindUI:CreateWindow({
    ...
    Title = "Adopt Me | Lokus Hub",

    Icon = "laptop",

    Author = "made by lokus",

    Folder = "LokusHubAdoptMe",
...
DiscordTab:Button({
    ...
    Callback = function()
        task.spawn(function()
            setclipboard("https://discord.gg/CVAVNnDmQE")
            WindUI:Notify({
                Title = "Copied",
                Content = "Lokus Hub Discord invite copied to clipboard!",
                Icon = "check",
                Duration = 3
            })
        end)
...
WindUI:Notify({
    Title = "Lokus Hub Loaded",
    Content = "All features ready to use!",
    Icon = "check",
    Duration = 5
})

print("[Lokus Hub] Successfully loaded!")
print("[Lokus Hub] Press L to toggle UI")
